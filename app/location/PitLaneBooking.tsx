...
export function PitLaneBooking({
  ...
  return (
    <>
      {/* Bridge astral : le catalogue crème plonge dans la nuit du Pit Lane */}
            ...
            <div className="cp-pl-side">
              ...
              <div className="cp-pl-tk cp-mono" aria-live="polite">
                ...
                <div className="cp-pl-tr dim">
                  ...
                  <span>
                    {formData.dateRetour
                      ? `→ ${formatJourCourt(formData.dateRetour)}`
                      : '→ retour —'}
                  </span>
                </div>
                <div className="cp-pl-tr dim">
      ...
      {/* Bridge astral de sortie : la nuit remonte vers la bande univers */}
