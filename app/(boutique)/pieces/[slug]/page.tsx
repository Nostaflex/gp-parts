...
export default async function ProductPage(props: PageProps) {
  ...
  return (
    <>
      ...
      {/* Fond clair + pt-28 : dégage le header fixe (le hero catalogue ne
          coiffe plus la PDP — audit #15, hero déplacé dans pieces/page.tsx) */}
      <div style={{ backgroundColor: '#F8F5F0', minHeight: '60vh' }} className="pt-28">
